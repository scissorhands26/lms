...
<InstructorTip tip="Students should not need any additional documents" />

**What is the IP Address of the DHCP Server?**

<InstructorTip tip="192.168.0.1" />

**What is the IP Address did the client receive?**

<InstructorTip tip="192.168.0.10" />
